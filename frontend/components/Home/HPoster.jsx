...
function HPoster() {
  return (
    <div className=" items-center  ">
      {/* Main Container */}
      {/* <div className="bg-white px-6 py-12 lg:px-20 w-4/5 mx-auto rounded-lg shadow-lg"> */}
      <div className="bg-white px-6 py-12 lg:px-20 w-4/5 mx-auto rounded-lg ">
        {/* Layout Container */}
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="relative lg:w-1/2 flex justify-center mt-10 lg:mt-0">
            <div className="relative">
              {/* Doctors Image */}
              <div className="rounded-full bg-white border-4 border-gray-200 shadow-lg w-80 h-80 flex items-center justify-center">
                <img
